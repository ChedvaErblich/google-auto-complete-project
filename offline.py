...
def init_node():
    self = [[None] * 36, {0: {}, -1: {}, -2: {}, -3: {}, -4: {}, -5: {}, -6: {}, -8: {}, -10: {} }]  # first for the highest score etc.
    return self


def insert(node, sub_line, index_sentence, offset): # insert with swap one letter, what do with score?
    node = node[0]
